...
<main role="main" class="l-common l-under">
    ...
    <section class="l-under-service m-inner">
        <div class="m-label02"><p>みらテラ提供するサービス一覧です</p></div>
        ...
        <div class="l-under-service__column">
            ...
            <div class="body">
                ...
                <div class="btn"><a class="m-btn-blue" href="<?php echo home_url();?>/business/">詳細を見る</a></div>
            </div>
        </div>
        <div class="l-under-service__column">
            ...
            <div class="body">
                ...
                <div class="btn"><a class="m-btn-blue" href="<?php echo home_url();?>/welfare/">詳細を見る</a></div>
            </div>
        </div>
        <div class="l-under-service__column">
            ...
            <div class="body">
                ...
                <div class="btn"><a class="m-btn-blue" href="<?php echo home_url();?>/customer/">詳細を見る</a></div>
            </div>
        </div>
    </section>
