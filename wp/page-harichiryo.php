...
<main role="main" class="l-common l-under">
    ...
    <section class="l-under-intro m-inner">
        ...
        <div class="l-under-intro__main -harichiryo">
            ...
            <p>鍼治療は、鍼による物理的刺激を与えることで、人が本来持っている体を正常に保つ反応や自己治癒力を活性化することで、様々な効果が得られる治療法です。<br>運動器系、神経系の疾患以外に、内分泌系（ホルモン）、消化器・循環器系にもその効果が認められ、WHO（世界保健機関）においても適応症状であると認められています。</p>
