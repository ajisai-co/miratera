...
仕様方法
ループ内
<?php ajsai_the_post_thumbnail(); ?>

ループ外
<?php ajsai_the_post_thumbnail( 記事ID, 'サイズ指定' ); ?>
*/

if ( ! function_exists( 'ajsai_get_post_thumbnail' ) ) {
  function ajsai_get_post_thumbnail( $post_id = null, $size = 'post-thumbnail' ) {
...
if ( ! function_exists( 'ajsai_the_post_thumbnail' ) ) {
  function ajsai_the_post_thumbnail( $post_id = null, $size = 'post-thumbnail' ) {
    echo ajsai_get_post_thumbnail( $post_id, $size );
  }
}
